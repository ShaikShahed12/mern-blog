...
export default function SignUp() {
  ...
  const [loading, setLoading] = useState(false); // Changed 'loadin' to 'loading'
      ...
      <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5">
        ...
        <div className="flex-1">
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <Button className="bg-pink-800" type="submit" disabled={loading}> {/* Disable button when loading */}
          ...
          {errorMessage && (
            <Alert className="mt-5 bg-pink-200 text-red-600 pl-2">
              {errorMessage}
            </Alert>
          )}
        </div>
